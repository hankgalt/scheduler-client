...
function deserialize_scheduler_v1_AddEntityRequest(buffer_arg) {
  return scheduler_pb.AddEntityRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_AddEntityResponse(buffer_arg) {
  return scheduler_pb.AddEntityResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_DeleteResponse(buffer_arg) {
  return scheduler_pb.DeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_DeleteRunRequest(buffer_arg) {
  return scheduler_pb.DeleteRunRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_scheduler_v1_EntityRequest(arg) {
  if (!(arg instanceof scheduler_pb.EntityRequest)) {
    throw new Error('Expected argument of type scheduler.v1.EntityRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_scheduler_v1_EntityRequest(buffer_arg) {
  return scheduler_pb.EntityRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_scheduler_v1_EntityResponse(arg) {
  if (!(arg instanceof scheduler_pb.EntityResponse)) {
    throw new Error('Expected argument of type scheduler.v1.EntityResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_scheduler_v1_EntityResponse(buffer_arg) {
  return scheduler_pb.EntityResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_FileSignalRequest(buffer_arg) {
  return scheduler_pb.FileSignalRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_scheduler_v1_FileWorkflowStateResponse(arg) {
  if (!(arg instanceof scheduler_pb.FileWorkflowStateResponse)) {
    throw new Error('Expected argument of type scheduler.v1.FileWorkflowStateResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_scheduler_v1_FileWorkflowStateResponse(buffer_arg) {
  return scheduler_pb.FileWorkflowStateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_scheduler_v1_QueryWorkflowRequest(arg) {
  if (!(arg instanceof scheduler_pb.QueryWorkflowRequest)) {
    throw new Error('Expected argument of type scheduler.v1.QueryWorkflowRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_scheduler_v1_QueryWorkflowRequest(buffer_arg) {
  return scheduler_pb.QueryWorkflowRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_SearchRunRequest(buffer_arg) {
  return scheduler_pb.SearchRunRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_scheduler_v1_StreamAddEntityResponse(arg) {
  if (!(arg instanceof scheduler_pb.StreamAddEntityResponse)) {
    throw new Error('Expected argument of type scheduler.v1.StreamAddEntityResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_scheduler_v1_StreamAddEntityResponse(buffer_arg) {
  return scheduler_pb.StreamAddEntityResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_scheduler_v1_UpdateRunRequest(buffer_arg) {
  return scheduler_pb.UpdateRunRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SchedulerService = exports.SchedulerService = {
  ...
  deleteEntity: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: scheduler_pb.EntityRequest,
    responseType: scheduler_pb.DeleteResponse,
    requestSerialize: serialize_scheduler_v1_EntityRequest,
    requestDeserialize: deserialize_scheduler_v1_EntityRequest,
    responseSerialize: serialize_scheduler_v1_DeleteResponse,
    responseDeserialize: deserialize_scheduler_v1_DeleteResponse,
  },
  getEntity: {
    ...
    responseStream: false,
    requestType: scheduler_pb.EntityRequest,
    responseType: scheduler_pb.EntityResponse,
    requestSerialize: serialize_scheduler_v1_EntityRequest,
    requestDeserialize: deserialize_scheduler_v1_EntityRequest,
    responseSerialize: serialize_scheduler_v1_EntityResponse,
    responseDeserialize: deserialize_scheduler_v1_EntityResponse,
  },
  addBusinessEntities: {
